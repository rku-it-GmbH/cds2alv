CLASS /c2a/cl_action_handler DEFINITION
  PUBLIC
  INHERITING FROM /c2a/cl_base_object
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES /c2a/if_action_handler.
...
CLASS /c2a/cl_action_handler IMPLEMENTATION.
  ...
  METHOD /c2a/if_action_handler~delete.
  ...
  METHOD /c2a/if_action_handler~execute_action.
  ...
  METHOD /c2a/if_action_handler~update.
