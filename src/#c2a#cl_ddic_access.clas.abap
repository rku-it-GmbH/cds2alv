CLASS /c2a/cl_ddic_access DEFINITION
  PUBLIC
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES /c2a/if_ddic_access.

  PROTECTED SECTION.

  PRIVATE SECTION.
    ALIASES exists_view                    FOR /c2a/if_ddic_access~exists_view.
    ALIASES get_annotations_for_cds_view   FOR /c2a/if_ddic_access~get_annotations_for_cds_view.
    ALIASES get_conditions_for_association FOR /c2a/if_ddic_access~get_conditions_for_association.
    ALIASES get_ddic_fields_for_cds_view   FOR /c2a/if_ddic_access~get_ddic_fields_for_cds_view.
    ALIASES get_last_modified_at           FOR /c2a/if_ddic_access~get_last_modified_at.
    ALIASES get_parameters_for_cds_view    FOR /c2a/if_ddic_access~get_parameters_for_cds_view.
    ALIASES get_sadl_runtime               FOR /c2a/if_ddic_access~get_sadl_runtime.
    ALIASES get_target_for_association     FOR /c2a/if_ddic_access~get_target_for_association.
    ALIASES get_mp_for_entity              FOR /c2a/if_ddic_access~get_mp_for_entity.

ENDCLASS.


CLASS /c2a/cl_ddic_access IMPLEMENTATION.
  METHOD /c2a/if_ddic_access~exists_view.
    SELECT SINGLE @abap_true FROM dd02b
     WHERE strucobjn = @i_cds_view
      INTO @r_exists.
  ENDMETHOD.

  METHOD /c2a/if_ddic_access~get_annotations_for_cds_view.
  ...
  METHOD /c2a/if_ddic_access~get_conditions_for_association.
    TRY.
        ...
        IF i_only_constants = abap_true.
          ...
          LOOP AT e_dd05bv_tab ASSIGNING FIELD-SYMBOL(<curr_dd05bv>).
            ...
            ASSIGN e_dd05bv_tab[ ( curr_tabix + 1 ) ] TO FIELD-SYMBOL(<prev_dd05bv>).
            IF sy-subrc = 0.
  ...
  METHOD /c2a/if_ddic_access~get_ddic_fields_for_cds_view.
  ...
  METHOD /c2a/if_ddic_access~get_last_modified_at.
  ...
  METHOD /c2a/if_ddic_access~get_mp_for_entity.
    TRY.
        r_mp = NEW /c2a/cl_sadl_mapping_provider( i_entity ).
  ...
  METHOD /c2a/if_ddic_access~get_parameters_for_cds_view.
    TRY.
        DATA dd_object TYPE REF TO if_dd_sobject.
  ...
  METHOD /c2a/if_ddic_access~get_sadl_runtime.
    TRY.
  ...
  METHOD /c2a/if_ddic_access~get_source_id.
    TRY.
  ...
  METHOD /c2a/if_ddic_access~get_target_for_association.
    TRY.
        DATA dd_object TYPE REF TO if_dd_sobject.
