CLASS /c2a/cl_memory DEFINITION
  PUBLIC
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES /c2a/if_memory.
...
CLASS /c2a/cl_memory IMPLEMENTATION.
  METHOD /c2a/if_memory~export_forall_table.
  ...
  METHOD /c2a/if_memory~import_forall_table.
