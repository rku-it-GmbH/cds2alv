CLASS /c2a/cl_report_controller DEFINITION
  PUBLIC
  INHERITING FROM /c2a/cl_base_object
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES /c2a/if_report_controller.
    INTERFACES /c2a/if_split_screen_contr.

    ALIASES ok_code FOR /c2a/if_split_screen_contr~ok_code.
    ...
    METHODS constructor
      IMPORTING i_cds_view           TYPE /c2a/cds_view_name
                ...
                i_selection_screen   TYPE REF TO /c2a/if_selection_screen
                i_selection          TYPE REF TO /c2a/if_selection
                i_builder            TYPE REF TO /c2a/if_grid_builder
                i_extension_provider TYPE REF TO /c2a/if_extension_provider
      RAISING   /c2a/cx_error_message.

  PROTECTED SECTION.
    DATA alternative_selection TYPE /c2a/report_extension_name.
    DATA alternative_display   TYPE /c2a/report_extension_name.
    ...
    DATA builder               TYPE REF TO /c2a/if_grid_builder.
    DATA extension_provider    TYPE REF TO /c2a/if_extension_provider.
    DATA extensions            TYPE /c2a/if_extension_provider=>ty_report_extensions.
...
CLASS /c2a/cl_report_controller IMPLEMENTATION.
  METHOD constructor.
  ...
  METHOD default_display.
    CASE i_in_split_screen.
      ...
      WHEN abap_true.
        ...
        CALL FUNCTION '/C2A/SPLIT_SCREEN'
          EXPORTING i_builder         = builder
                    i_table_container = table_container
  ...
  METHOD /c2a/if_report_controller~at_help_request.
    TRY.
      ...
      CATCH /c2a/cx_error_message INTO DATA(exception).
        MESSAGE exception TYPE 'I' DISPLAY LIKE 'E'.
    ENDTRY.
  ENDMETHOD.

  METHOD /c2a/if_report_controller~at_selection_screen.
    TRY.
        LOOP AT extensions INTO DATA(extension).
  ...
  METHOD /c2a/if_report_controller~at_selection_screen_output.
    TRY.
  ...
  METHOD /c2a/if_report_controller~at_value_request.
    TRY.
  ...
  METHOD /c2a/if_report_controller~initialization.
    TRY.
        LOOP AT extensions INTO DATA(extension).
  ...
  METHOD /c2a/if_report_controller~start_of_selection.
    DATA ref_to_table TYPE REF TO data.
  ...
  METHOD /c2a/if_split_screen_contr~handle_user_command.
    CASE i_ok_code.
      WHEN ok_code-select.
        select( ).
