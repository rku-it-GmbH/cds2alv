CLASS /c2a/cl_report_generator DEFINITION
  PUBLIC
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES /c2a/if_report_generator.
    ...
    DATA strategy    TYPE REF TO /c2a/if_report_strategy.
...
CLASS /c2a/cl_report_generator IMPLEMENTATION.
  METHOD constructor.
    factory = i_factory.
  ...
  METHOD /c2a/if_report_generator~generate_report.
    ...
    IF sy-subrc <> 0.
      RAISE EXCEPTION TYPE /c2a/cx_error_message MESSAGE e006(/c2a/cds_alv) WITH i_cds_view line word.
    ENDIF.
