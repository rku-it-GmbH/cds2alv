CLASS /c2a/cl_selection DEFINITION
  PUBLIC
  INHERITING FROM /c2a/cl_base_object
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES /c2a/if_selection.
...
CLASS /c2a/cl_selection IMPLEMENTATION.
  METHOD constructor.
  ...
  METHOD /c2a/if_selection~perform_reselection.
  ...
  METHOD /c2a/if_selection~perform_selection.
  ...
  METHOD /c2a/if_selection~perform_selection_forall.
    TRY.
        DATA(parameters) = VALUE if_sadl_query_engine_types=>ty_parameters(
            entity = VALUE #(
