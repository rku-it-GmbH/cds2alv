...
*&      Form  BUILD_GRID
*&---------------------------------------------------------------------*
FORM build_grid RAISING /c2a/cx_error_message.
  ...
  IF alv_grid IS NOT BOUND.
    ...
    alv_grid->set_table_for_first_display(
      EXPORTING
        i_structure_name     = '/C2A/REPORT_EXTENSION'
        i_save               = 'A'
        is_layout            = layout
...
*&      Form  CLOSE_DISPLAY
*&---------------------------------------------------------------------*
FORM close_display RAISING /c2a/cx_error_message.
...
*&      Form  SAVE_CHANGES
*&---------------------------------------------------------------------*
FORM save_changes RAISING /c2a/cx_error_message.
  alv_grid->check_changed_data( ).
  persistence->set_report_extensions( i_cds_view   = cds_view
