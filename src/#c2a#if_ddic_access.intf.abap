...
INTERFACE /c2a/if_ddic_access PUBLIC.
  ...
  "! @raising   /c2a/cx_error_message | Invalid combination of source view and association
  METHODS get_target_for_association
    ...
    RETURNING VALUE(r_target_view) TYPE /c2a/cds_view_name
  ...
  METHODS get_conditions_for_association
    ...
    EXPORTING e_target_view      TYPE /c2a/cds_view_name
  ...
  "! @raising   /c2a/cx_error_message | Occurs when the CDS View does not exist
  ...
  "! @raising   /c2a/cx_error_message | Occurs when the source entity ID cannot be obtained from the entity
  ...
  "! @raising   /c2a/cx_error_message | Occurs when the mapping provider cannot be obtained from the entity
