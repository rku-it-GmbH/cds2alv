...
INTERFACE /c2a/if_grid_builder PUBLIC.
  ...
  "! @raising   /c2a/cx_error_message | Errors during the setup of the ALV grid are propagated
  ...
  "! @raising   /c2a/cx_error_message | Errors during metadata assembly are propagated
  METHODS get_metadata
    IMPORTING i_table_container TYPE REF TO /c2a/if_table_container
  ...
  METHODS register_alternative_selection
    IMPORTING i_selection_handler TYPE REF TO /c2a/if_selection_extension.
