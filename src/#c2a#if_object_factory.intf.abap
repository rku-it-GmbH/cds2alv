...
INTERFACE /c2a/if_object_factory PUBLIC.
  "! Provides an instance for authority checks
  "! @parameter r_authority_checker   | Instance of the authority checker
  "! @raising   /c2a/cx_error_message | Implementation cannot be instantiated
  METHODS get_authority_checker
    RETURNING VALUE(r_authority_checker) TYPE REF TO /c2a/if_authority_check
  ...
  METHODS get_action_handler
    ...
    RETURNING VALUE(r_action_handler) TYPE REF TO /c2a/if_action_handler
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_builder
    IMPORTING i_cds_view       TYPE /c2a/cds_view_name
    RETURNING VALUE(r_builder) TYPE REF TO /c2a/if_grid_builder
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_ddic_access
    RETURNING VALUE(r_ddic_access) TYPE REF TO /c2a/if_ddic_access
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_extension_provider
    RETURNING VALUE(r_extension_provider) TYPE REF TO /c2a/if_extension_provider
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_generation_strategy
    IMPORTING i_cds_view        TYPE /c2a/cds_view_name
    RETURNING VALUE(r_strategy) TYPE REF TO /c2a/if_report_strategy
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_launcher
    RETURNING VALUE(r_launcher) TYPE REF TO /c2a/if_report_launcher
    RAISING   /c2a/cx_error_message.
  ...
  "! @raising   /c2a/cx_error_message | Implementation cannot be instantiated
  METHODS get_memory
    RETURNING VALUE(r_memory) TYPE REF TO /c2a/if_memory
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_navigation
    RETURNING VALUE(r_navigation) TYPE REF TO /c2a/if_navigation
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_persistence
    RETURNING VALUE(r_persistence) TYPE REF TO /c2a/if_persistence
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_report_controller
    IMPORTING i_cds_view          TYPE /c2a/cds_view_name
    RETURNING VALUE(r_controller) TYPE REF TO /c2a/if_report_controller
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_report_generator
    RETURNING VALUE(r_generator) TYPE REF TO /c2a/if_report_generator
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_selection
    IMPORTING i_cds_view         TYPE /c2a/cds_view_name
    RETURNING VALUE(r_selection) TYPE REF TO /c2a/if_selection
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_selection_screen
    IMPORTING i_cds_view                TYPE /c2a/cds_view_name
    RETURNING VALUE(r_selection_screen) TYPE REF TO /c2a/if_selection_screen
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_table_container
    IMPORTING i_cds_view               TYPE /c2a/cds_view_name
    RETURNING VALUE(r_table_container) TYPE REF TO /c2a/if_table_container
    RAISING   /c2a/cx_error_message.
  ...
  METHODS get_value_help
    IMPORTING i_cds_view          TYPE /c2a/cds_view_name
    RETURNING VALUE(r_value_help) TYPE REF TO /c2a/if_value_help
    RAISING   /c2a/cx_error_message.
ENDINTERFACE.
