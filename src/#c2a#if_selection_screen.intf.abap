...
INTERFACE /c2a/if_selection_screen PUBLIC.
  INTERFACES /c2a/if_condition_provider.

  ALIASES get_parameters FOR /c2a/if_condition_provider~get_parameters.
  ALIASES get_selections FOR /c2a/if_condition_provider~get_selections.
  ...
  "! @raising /c2a/cx_error_message | Errors while reading the selection screen are propagated
  ...
  "! @raising   /c2a/cx_error_message | Occurs when name or value is invalid
  ...
  "! @raising /c2a/cx_error_message |  Occurs when restrictions cannot be applied
  METHODS apply_restriction
    RAISING /c2a/cx_error_message.

  "! Applies new texts to the parameters and select-options.
  "! @raising /c2a/cx_error_message | Occurs when texts cannot be applied
  ...
  "! @raising   /c2a/cx_error_message | Errors during value help processing ar propagated
  ...
  "! @raising /c2a/cx_error_message | Errors during screen modification are propagated
