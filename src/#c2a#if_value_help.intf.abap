...
INTERFACE /c2a/if_value_help PUBLIC.
  ...
  "! @raising   /c2a/cx_error_message | Errors during value help processing are propagated
  ...
  METHODS value_help_for_parameter
    IMPORTING i_parname   TYPE /c2a/cds_parameter_name
              i_display   TYPE abap_bool DEFAULT abap_false
    EXPORTING e_processed TYPE abap_bool
    CHANGING  c_value     TYPE any
    RAISING   /c2a/cx_error_message.
