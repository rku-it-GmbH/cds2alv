*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/C2A/M_EXT_HDR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/C2A/M_EXT_HDR      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/C2A/M_EXT_HDR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /C2A/M_EXT_HDR_EXTRACT
TOTAL = /C2A/M_EXT_HDR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/C2A/M_EXT_HDR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/C2A/M_EXT_HDR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /C2A/M_EXT_HDR_EXTRACT
TOTAL = /C2A/M_EXT_HDR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/C2A/M_EXT_HDR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/C2A/M_EXT_HDR'
...
TOTAL = /C2A/M_EXT_HDR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/C2A/M_EXT_HDR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/C2A/M_EXT_HDR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/C2A/M_EXT_HDR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/C2A/M_EXT_HDR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /C2A/M_EXT_HDR_EXTRACT
TOTAL = /C2A/M_EXT_HDR_TOTAL
