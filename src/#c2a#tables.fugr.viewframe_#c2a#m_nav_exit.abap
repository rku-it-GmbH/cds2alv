*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/C2A/M_NAV_EXIT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/C2A/M_NAV_EXIT     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/C2A/M_NAV_EXIT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /C2A/M_NAV_EXIT_EXTRACT
TOTAL = /C2A/M_NAV_EXIT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/C2A/M_NAV_EXIT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/C2A/M_NAV_EXIT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /C2A/M_NAV_EXIT_EXTRACT
TOTAL = /C2A/M_NAV_EXIT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/C2A/M_NAV_EXIT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/C2A/M_NAV_EXIT'
...
TOTAL = /C2A/M_NAV_EXIT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/C2A/M_NAV_EXIT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/C2A/M_NAV_EXIT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/C2A/M_NAV_EXIT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/C2A/M_NAV_EXIT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /C2A/M_NAV_EXIT_EXTRACT
TOTAL = /C2A/M_NAV_EXIT_TOTAL
