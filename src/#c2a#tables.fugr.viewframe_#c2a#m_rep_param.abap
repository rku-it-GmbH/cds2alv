*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/C2A/M_REP_PARAM
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/C2A/M_REP_PARAM    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/C2A/M_REP_PARAM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /C2A/M_REP_PARAM_EXTRACT
TOTAL = /C2A/M_REP_PARAM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/C2A/M_REP_PARAM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/C2A/M_REP_PARAM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /C2A/M_REP_PARAM_EXTRACT
TOTAL = /C2A/M_REP_PARAM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/C2A/M_REP_PARAM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/C2A/M_REP_PARAM'
...
TOTAL = /C2A/M_REP_PARAM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/C2A/M_REP_PARAM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/C2A/M_REP_PARAM-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/C2A/M_REP_PARAM'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/C2A/M_REP_PARAM-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /C2A/M_REP_PARAM_EXTRACT
TOTAL = /C2A/M_REP_PARAM_TOTAL
