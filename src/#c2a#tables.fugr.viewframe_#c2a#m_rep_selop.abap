*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/C2A/M_REP_SELOP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/C2A/M_REP_SELOP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/C2A/M_REP_SELOP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /C2A/M_REP_SELOP_EXTRACT
TOTAL = /C2A/M_REP_SELOP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/C2A/M_REP_SELOP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/C2A/M_REP_SELOP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /C2A/M_REP_SELOP_EXTRACT
TOTAL = /C2A/M_REP_SELOP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/C2A/M_REP_SELOP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/C2A/M_REP_SELOP'
...
TOTAL = /C2A/M_REP_SELOP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/C2A/M_REP_SELOP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/C2A/M_REP_SELOP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/C2A/M_REP_SELOP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/C2A/M_REP_SELOP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /C2A/M_REP_SELOP_EXTRACT
TOTAL = /C2A/M_REP_SELOP_TOTAL
